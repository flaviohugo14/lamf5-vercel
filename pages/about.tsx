      ...
      <Header />
        <article className="mb-32 about">
          ...
          <div className="presidencia">
            <img src="https://lamf5.s3-sa-east-1.amazonaws.com/authors/alice.jpeg" className="profile" alt="Alice Másala" />
            <div className="group">
          ...
          <div className="presidencia">
            <img src="https://lamf5.s3-sa-east-1.amazonaws.com/authors/breno.jpeg" className="profile" alt="Breno Schiavon" />
            <div className="group">
          ...
          <div className="presidencia">
            <img src="https://lamf5.s3-sa-east-1.amazonaws.com/authors/dalbert.jpeg" className="profile" alt="Dalbert Viana Gregório" />
            <div className="group">
          ...
          <div className="presidencia">
            <img src="https://lamf5.s3-sa-east-1.amazonaws.com/authors/maciel.jpeg" className="profile" alt="Maciel Maçal Neto" />
            <div className="group">
          ...
          <div className="presidencia">
            <img src="https://lamf5.s3-sa-east-1.amazonaws.com/authors/kaio.jpeg" className="profile" alt="Maciel Maçal Neto" />
            <div className="group">
